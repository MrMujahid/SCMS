...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('asset')}}/vendors/iconfonts/font-awesome/css/all.min.css">
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h3><i class="fas fa-globe"></i> Quick Fix</h3>
              ...
              <form action="{{route('auth')}}" method="post" class="pt-3">
                ...
                <div class="form-group">
                  <input type="text" name="txtUsername" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="admin">
                </div>
                <div class="form-group">
                  <input type="password" name="txtPassword" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="1234">
                </div>
                <div class="mt-3">
                    <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"> Sign In</button>
                  <!-- <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="{{asset('asset')}}/index-2.html">SIGN IN</a> -->
                </div>
