<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      ...
      <h3><i class="fas fa-globe"></i> Quick Fix</h3>
        <!-- <a class="navbar-brand brand-logo" href="home"><img src="{{asset('asset')}}/images/logo.svg" alt="logo"/></a> -->
        <a class="navbar-brand brand-logo-mini" href="home"><img src="{{asset('asset')}}/images/logo-mini.svg" alt="logo"/></a>
      </div>
